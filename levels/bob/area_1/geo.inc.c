...
const GeoLayout bob_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_TRANSPARENT, 28, -4890, -37, bob_dl_Death_Plane_mesh_layer_5),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 427, 1160, -1655, bob_dl_Island_mesh_layer_1),
		GEO_TRANSLATE_NODE(LAYER_OPAQUE, 28, 100, -37),
		GEO_TRANSLATE_NODE(LAYER_OPAQUE, 28, 100, -37),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 28, 100, -37, bob_dl_Terrain_mesh_layer_1),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
