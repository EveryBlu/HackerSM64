COURSE_ACTS(COURSE_BOB, _(" 1 TEST REALM"),
       _("TOP O' THE SPIRE")     , _("KING OF THE HILL") , _("AMONG THE LONELY ISLE"),
       _("TESTING FOR 8 RED COINS")          , _("MARIO WINGS TO THE SKY")        , _("BEHIND CHAIN CHOMP'S GATE"))
